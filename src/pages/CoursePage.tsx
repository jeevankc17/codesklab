...
const CoursePage: FunctionComponent = () => {
  ...
  const onButtonswhiteContentContainerClick1 = useCallback(() => {
    //TODO: button link
  }, []);
  ...
  const onButtonswhiteContentContainerClick2 = useCallback(() => {
    //TODO: button link
  }, []);
  ...
  const onButtonswhiteContentContainerClick3 = useCallback(() => {
    //TODO: button link
  }, []);
  ...
  const onButtonswhiteContentContainerClick4 = useCallback(() => {
    //TODO: button link
  }, []);
  ...
  const onButtonswhiteContentContainerClick5 = useCallback(() => {
    //TODO: button link
  }, []);
  ...
  const onButtonscurriculumContainerClick6 = useCallback(() => {
    //TODO: button link
  }, []);

  const onButtonscurriculumContainerClick7 = useCallback(() => {
    //TODO: button link
  }, []);

  const onButtonscurriculumContainerClick8 = useCallback(() => {
    //TODO: button link
  }, []);

  const onButtonscurriculumContainerClick9 = useCallback(() => {
    //TODO: button link
  }, []);

  const onButtonscurriculumContainerClick10 = useCallback(() => {
    //TODO: button link
  }, []);

  const onButtonscurriculumContainerClick11 = useCallback(() => {
    //TODO: button link
  }, []);
  ...
  return (
    <>
      <div className="w-full relative bg-nero flex flex-col items-center justify-start p-5 box-border gap-[20px] text-left text-17xl text-darkslategray font-body-tiny-400">
        ...
        <div className="self-stretch rounded-mini bg-footer-header flex flex-row items-center justify-between py-0 px-[15px] z-[4] text-29xl text-nero lg:flex-col md:flex-col">
        ...
        <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[30px] relative z-[3] text-center">
          <div className="self-stretch bg-gray1-100 flex flex-col items-center justify-start">
            <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[50px]">
              <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px]">
                ...
                <div className="self-stretch flex flex-row items-center justify-center p-2.5 text-sm text-black1">
                  <div className="flex-1 relative leading-[150%]">
                    Learn only what you want to learn with coding courses
                    focused on app development, website building, game
                    development, data science, or more
                  </div>
                </div>
              </div>
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-5 gap-[50px] text-left text-base text-black1">
                <div
                ...
                >
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-5xl text-dodger-blue">
                    ...
                    <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[5px] text-sm text-darkslategray">
                ...
                >
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-5xl text-dodger-blue">
                    ...
                    <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[5px] text-sm text-darkslategray">
                      ...
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Learning Lua programming language to create
                          interactive game mechanics and functionalities.
                        </div>
                      </div>
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        <img
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Understanding the fundamentals of game design to
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-start gap-[5px] text-center text-lg text-aqua-deep">
                    <div
                      className="self-stretch rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 cursor-pointer border-[1px] border-solid border-aqua-deep"
                      onClick={onButtonswhiteContentContainerClick1}
                    >
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">
                        View Curriculum
                      </div>
                ...
                >
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-5xl text-dodger-blue">
                    ...
                    <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[5px] text-sm text-darkslategray">
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Building mobile apps without traditional coding using
                      ...
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Integrating various features such as sensors, APIs,
                          and databases into app development.
                        </div>
                      </div>
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        <img
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Understanding the app development lifecycle from
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-start gap-[5px] text-center text-lg text-aqua-deep">
                    <div
                      className="self-stretch rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 cursor-pointer border-[1px] border-solid border-aqua-deep"
                      onClick={onButtonswhiteContentContainerClick2}
                    >
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">
                        View Curriculum
                      </div>
                ...
                >
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-5xl text-dodger-blue">
                    ...
                    <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[5px] text-sm text-darkslategray">
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Learning about smart devices and how they interact
                          with the internet to perform various tasks.
                        </div>
                      </div>
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        <img
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Understanding the role of sensors in collecting data
                          and actuators in performing actions in IoT systems.
                        </div>
                      </div>
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        <img
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-start gap-[5px] text-center text-lg text-aqua-deep">
                    <div
                      className="self-stretch rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 cursor-pointer border-[1px] border-solid border-aqua-deep"
                      onClick={onButtonswhiteContentContainerClick3}
                    >
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">
                        View Curriculum
                      </div>
                ...
                >
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-start gap-[5px] text-center text-lg text-aqua-deep">
                    <div
                      className="self-stretch rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 cursor-pointer border-[1px] border-solid border-aqua-deep"
                      onClick={onButtonswhiteContentContainerClick4}
                    >
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">
                        View Curriculum
                      </div>
                ...
                >
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-5xl text-dodger-blue">
                    ...
                    <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[5px] text-sm text-darkslategray">
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        ...
                        />
                        <div className="flex-1 relative tracking-[-0.01em] leading-[22px] whitespace-pre-wrap">
                          Understanding of UI/UX principles using Figma then
                          HTML, CSS, and JavaScript for creating interactive web
                          pages.
                        </div>
                      </div>
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-start gap-[5px] text-center text-lg text-aqua-deep">
                    <div
                      className="self-stretch rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 cursor-pointer border-[1px] border-solid border-aqua-deep"
                      onClick={onButtonswhiteContentContainerClick5}
                    >
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">
                        View Curriculum
                      </div>
        ...
        <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[50px] z-[2] text-center">
              ...
              <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-left text-sm text-blues font-body-tiny-400">
                ...
                <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-darkslategray">
                  ...
                  <div
                    ...
                    onClick={onButtonscurriculumContainerClick6}
                  >
                    <div className="self-stretch flex-1 rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 border-[1px] border-solid border-aqua-deep">
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">{`Download Curriculum `}</div>
                      <div className="self-stretch w-[27.5px] flex flex-col items-start justify-center py-0 pr-0 pl-[7.5px] box-border">
                ...
                <div
                  ...
                  onClick={onButtonscurriculumContainerClick7}
                >
                  <div className="self-stretch flex-1 rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 border-[1px] border-solid border-aqua-deep">
                    <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">{`Download Curriculum `}</div>
                    <div className="self-stretch w-[27.5px] flex flex-col items-start justify-center py-0 pr-0 pl-[7.5px] box-border">
            ...
            <div className="w-[350px] shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden shrink-0 flex flex-col items-start justify-start p-2.5 box-border gap-[10px]">
              ...
              <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-left text-sm text-blues font-body-tiny-400">
                ...
                <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-darkslategray">
                  ...
                  <div
                    className="w-[310px] hidden flex-row items-center justify-center cursor-pointer text-center text-lg text-aqua-deep"
                    onClick={onButtonscurriculumContainerClick8}
                  >
                    <div className="self-stretch flex-1 rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 border-[1px] border-solid border-aqua-deep">
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">{`Download Curriculum `}</div>
                      <div className="self-stretch w-[27.5px] flex flex-col items-start justify-center py-0 pr-0 pl-[7.5px] box-border">
                ...
                <div
                  className="self-stretch flex flex-row items-center justify-center cursor-pointer text-center text-lg text-aqua-deep"
                  onClick={onButtonscurriculumContainerClick9}
                >
                  <div className="self-stretch flex-1 rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 border-[1px] border-solid border-aqua-deep">
                    <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">{`Download Curriculum `}</div>
                    <div className="self-stretch w-[27.5px] flex flex-col items-start justify-center py-0 pr-0 pl-[7.5px] box-border">
            ...
            <div className="w-[350px] shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden shrink-0 flex flex-col items-start justify-start p-2.5 box-border gap-[10px]">
              ...
              <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-left text-sm text-blues font-body-tiny-400">
                ...
                <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-darkslategray">
                  ...
                  <div
                    className="w-[310px] hidden flex-row items-center justify-center cursor-pointer text-center text-lg text-aqua-deep"
                    onClick={onButtonscurriculumContainerClick10}
                  >
                    <div className="self-stretch flex-1 rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 border-[1px] border-solid border-aqua-deep">
                      <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">{`Download Curriculum `}</div>
                      <div className="self-stretch w-[27.5px] flex flex-col items-start justify-center py-0 pr-0 pl-[7.5px] box-border">
                ...
                <div
                  className="self-stretch flex flex-row items-center justify-center cursor-pointer text-center text-lg text-aqua-deep"
                  onClick={onButtonscurriculumContainerClick11}
                >
                  <div className="self-stretch flex-1 rounded bg-nero flex flex-row items-center justify-center py-[9px] px-5 border-[1px] border-solid border-aqua-deep">
                    <div className="relative leading-[150%] font-semibold inline-block max-h-[58px]">{`Download Curriculum `}</div>
                    <div className="self-stretch w-[27.5px] flex flex-col items-start justify-center py-0 pr-0 pl-[7.5px] box-border">
        ...
        <section className="self-stretch bg-nero flex flex-col items-center justify-center p-5 gap-[20px] z-[1] text-center text-17xl text-darkslategray font-body-tiny-400">
