...
const CurriculumByCoursePage: FunctionComponent = () => {
  ...
  return (
    <>
      <div className="w-full relative bg-nero flex flex-col items-start justify-center p-5 box-border gap-[20px] text-left text-13xl text-darkslategray font-body-tiny-400">
        ...
        <div className="self-stretch rounded-mini bg-footer-header flex flex-row items-center justify-between py-0 px-[15px] z-[3] text-base text-nero lg:flex-col md:flex-col">
        ...
        <div className="self-stretch flex flex-col items-start justify-center z-[2] text-17xl">
          <div className="self-stretch flex flex-row items-start justify-center gap-[20px] lg:flex-col">
            <div className="w-[859px] flex flex-col items-start justify-start z-[1] lg:w-full">
              <div className="self-stretch bg-nero flex flex-col items-start justify-center py-0 px-[5px] gap-[5px] z-[4]">
                ...
                <div className="self-stretch flex flex-row items-center justify-center py-2.5 px-0 text-sm text-black1">
              ...
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center z-[3] text-13xl text-wwwcodingalcom-mine-shaft font-inter">
                <div className="flex-1 shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden flex flex-col items-start justify-start p-2.5 box-border gap-[10px] max-h-[709px]">
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-sm text-black1 font-body-tiny-400">
              ...
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center z-[2]">
                <div className="flex-1 shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden flex flex-col items-start justify-start p-2.5 box-border gap-[10px] max-h-[709px]">
                  ...
                  <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-sm text-black1">
                    <div className="self-stretch flex flex-col items-center justify-center gap-[9px]">
                      <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                        <img
                          className="w-8 relative h-8 overflow-hidden shrink-0"
              ...
              <div className="self-stretch shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden flex flex-col items-start justify-start p-2.5 box-border gap-[10px] max-h-[709px] z-[1] text-sm text-black1">
              ...
              <div className="self-stretch shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden flex flex-col items-start justify-start p-2.5 box-border gap-[10px] max-h-[709px] z-[0] text-center">
                ...
                <div className="self-stretch bg-nero flex flex-col items-center justify-center p-[5px] gap-[5px] text-left text-sm">
                  ...
                  <div className="self-stretch bg-ghostwhite flex flex-col items-center justify-center gap-[9px]">
                    <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                      <img
                        className="w-6 relative h-6 overflow-hidden shrink-0"
                        alt=""
            ...
            <div className="self-stretch w-[521px] flex flex-row items-start justify-center z-[0] text-sm font-inter lg:self-stretch lg:w-full">
              <div className="flex-1 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-nero flex flex-col items-center justify-center p-2.5 sticky gap-[15px] top-[77] lg:flex-1">
                <img
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[5px] z-[2] text-mid-6 font-segoe-ui">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-sm text-wwwcodingalcom-mine-shaft font-body-tiny-400">
        ...
        <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[1] text-center font-inter">
          <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px]">
            ...
            <div className="self-stretch flex flex-row items-center justify-center py-2.5 px-[50px] text-xl text-wwwcodingalcom-mine-shaft font-body-tiny-400">
          ...
          <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-5 gap-[50px] text-left text-5xl text-wwwcodingalcom-mine-shaft font-body-tiny-400">
            <div className="w-[350px] shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] rounded bg-nero overflow-hidden shrink-0 flex flex-col items-start justify-start p-2.5 box-border gap-[10px] max-h-[709px]">
              ...
              <div className="self-stretch flex flex-col items-center justify-center gap-[9px] text-sm text-darkslategray">
                <div className="self-stretch flex flex-row items-center justify-center gap-[5px]">
                  <img
                    className="w-8 relative h-8 overflow-hidden shrink-0"
                    alt=""
            ...
            <div className="w-[471px] bg-nero flex flex-col items-center justify-center p-2.5 box-border gap-[10px]">
              ...
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-[10px] text-center text-sm text-darkslategray">
        ...
        <div className="self-stretch flex flex-col items-center justify-start z-[0] text-black1 font-inter">
          <img
