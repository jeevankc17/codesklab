...
const CommingSoonPage: FunctionComponent = () => {
  ...
  return (
    <>
      <div className="w-full relative bg-nero1 flex flex-col items-center justify-start p-5 box-border gap-[20px] text-left text-lg text-primary-500 font-body-xl-500 sm:pl-[5px] sm:pr-[5px] sm:box-border">
        ...
        <div className="self-stretch bg-nero1 flex flex-row items-center justify-between py-0 px-[15px] z-[1] md:flex-col sm:pl-[5px] sm:pr-[5px] sm:box-border">
