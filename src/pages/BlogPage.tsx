  ...
  return (
    <>
      <div className="w-full relative bg-nero flex flex-col items-center justify-start p-5 box-border gap-[20px] text-left text-29xl text-nero font-body-tiny-400">
        ...
        <div
          className="self-stretch bg-nero flex flex-col items-center justify-center gap-[30px] relative cursor-pointer z-[1] text-center text-17xl text-darkslategray"
        ...
        >
          ...
          <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-5 text-left text-sm text-black1">
            <div className="w-[350px] rounded-lg bg-nero flex flex-col items-center justify-start p-2.5 box-border gap-[15px]">
              ...
              <div className="self-stretch bg-nero box-border overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[5px] gap-[15px] min-h-[52.5px] border-[1px] border-solid border-nero">
                <div className="self-stretch flex flex-col items-start justify-start gap-[2px] text-5xl">
                  ...
                  <div className="self-stretch relative text-base leading-[150%] text-wwwcodingalcom-mine-shaft">
                    Amit Dhanwani on March 29, 2024
                  </div>
                </div>
                <div className="w-80 relative leading-[150%] font-medium text-wwwcodingalcom-mine-shaft flex items-center max-w-[320px]">
                  <a
