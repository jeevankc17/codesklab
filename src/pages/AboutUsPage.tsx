...
const AboutUsPage: FunctionComponent = () => {
  ...
  return (
    <>
      <div className="w-full relative bg-nero flex flex-col items-center justify-start p-5 box-border gap-[20px] text-center text-13xl text-darkslategray font-inter sm:pl-[5px] sm:pr-[5px] sm:box-border">
        ...
        <div className="self-stretch rounded-mini bg-footer-header flex flex-row items-center justify-between py-0 px-[15px] z-[4] text-left text-29xl text-nero font-body-tiny-400 lg:flex-col md:flex-col">
          <div className="flex-1 flex flex-col items-center justify-center p-[15px] gap-[34px] lg:order-[2] lg:flex-[unset] lg:self-stretch md:order-[2] md:flex-[unset] md:self-stretch">
            <div className="self-stretch flex flex-col items-start justify-start">
              <div className="self-stretch relative leading-[120%] font-semibold">{`Building the world’s largest & most loved coding school for kids & teens`}</div>
            </div>
        ...
        <div className="self-stretch bg-nero flex flex-col items-center justify-center gap-[15px] z-[3]">
          <div className="self-stretch bg-nero flex flex-col items-center justify-center py-0 px-[5px] gap-[5px]">
            ...
            <div className="self-stretch flex flex-row items-center justify-center p-2.5 text-xl text-dimgray font-body-tiny-400">
              <div className="flex-1 relative leading-[32px]">
                With over 50 years of combined experience, we have got a
                well-seasoned team at the helm.
              </div>
            </div>
          </div>
          <div className="self-stretch flex flex-row flex-wrap items-center justify-center p-[15px] gap-[15px] text-base text-wwwcodingalcom-mine-shaft font-body-tiny-400 md:flex-row md:flex-wrap">
        ...
        <div className="self-stretch flex flex-col items-center justify-start z-[0] text-left text-black1">
          <img
